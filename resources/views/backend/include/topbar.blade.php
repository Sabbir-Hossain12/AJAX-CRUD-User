...
{{--                                    <img src="{{asset($basic_info->black_logo)}}" alt="" width="80%" height="24">--}}
                    ...
                    <span class="logo-lg fw-bold text-uppercase">
...
{{--                                    <img src="{{asset($basic_info->light_logo)}}" alt="" height="24">--}}
                    ...
                    <span class="logo-lg">
                                    <img src="" alt="" height="24"> <span class="logo-txt">Minia</span>
                                </span>
                </a>
            </div>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item bg-soft-light border-start border-end"
                    ...
                    <img class="rounded-circle header-profile-user"
                         src="{{asset('public/backend')}}/assets/images/users/avatar-1.jpg"
                         alt="Header Avatar">
